...
const EditDrawer = () => {
  ...
  const {
    editDrawer,
    toggleEditDrawer,
    editCourse: { id, short_name, title, fee },
    updateCourse,
  ...
  return (
    <div
      ...
      } z-40 h-screen p-4 overflow-y-auto transition-transform bg-white w-80 dark:bg-gray-800 shadow`}
    ...
    >
      ...
      {/* edit form */}
      <form id="courseEditForm" onSubmit={handleSubmit}>
        <input
          type="hidden"
          name="edit_course_id"
          id="edit_course_id"
